...
for(let i=0;i<9000;i++){
  ...
  if(travelled>4500 && d<step*6){ console.log("CLOSED i=",i,"trav",travelled.toFixed(0),"dist",d.toFixed(1),"pts",points.length,"spacing",spacing.toFixed(2)); break; }
  if(i===8999) console.log("NO CLOSURE pts",points.length,"trav",travelled.toFixed(0));
}
